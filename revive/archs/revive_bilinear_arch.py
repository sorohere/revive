...
from .revivev1_arch import ResUpBlock
...
class REVIVEBilinear(nn.Module):
    """The REVIVE architecture: Unet + StyleGAN2 decoder with SFT.

    It is the bilinear version and it does not use the complicated UpFirDnSmooth function that is not friendly for
    deployment. It can be easily converted to the clean version: REVIVEv1Clean.
    ...
    def __init__(
        ...
        super(REVIVEBilinear, self).__init__()
    ...
    def forward(self, x, return_latents=False, return_rgb=True, randomize_noise=True):
        """Forward function for REVIVEBilinear.
